...
--
-- Table structure for table `tbl_mahasiswa2026`
--

CREATE TABLE `tbl_mahasiswa2026` (
  `cid` int NOT NULL,
...
--
-- Dumping data for table `tbl_mahasiswa2026`
--

INSERT INTO `tbl_mahasiswa2026` (`cid`, `cnama`, `cemail`, `cpesan`, `dcreated_at`) VALUES
...
--
-- Indexes for table `tbl_mahasiswa2026`
--
ALTER TABLE `tbl_mahasiswa2026`
  ADD PRIMARY KEY (`cid`);
...
--
-- AUTO_INCREMENT for table `tbl_mahasiswa2026`
--
ALTER TABLE `tbl_mahasiswa2026`
