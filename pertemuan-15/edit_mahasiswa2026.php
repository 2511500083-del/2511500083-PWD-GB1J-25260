<?php
  ...
  */
  ...
  /*
    ...
    kembalikan pengguna ke halaman awal (read_mahasiswa2026.php) sembari 
  ...
  */
  $stmt = mysqli_prepare($conn, "SELECT cid, cnama, cemail, cpesan 
                                    FROM tbl_mahasiswa2026 WHERE cid = ? LIMIT 1");
  if (!$stmt) {
  ...
  <body>
    ...
    <main>
      <section id="contact">
        ...
        <?php endif; ?>
        <form action="proses_updatemahasiswa2026.php" method="POST">
          ...
          <a href="read_mahasiswa2026.php" class="reset">Kembali</a>
        </form>
      </section>
    </main>
